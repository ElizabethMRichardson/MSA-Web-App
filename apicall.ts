...
function apiConnection() {
    ...
    //var inputValue = foo();
    var inputValue = (<HTMLInputElement>document.getElementById('selectCity')).value;
...
function fillHtml(temperature, weather){
    ...
    if(weather == 961 || weather == 901 || weather == 960 || (weather >= 200 && weather < 300)){
       ...
       // document.body.style.backgroundImage = "url('http://webneel.com/wallpaper/sites/default/files/images/08-2013/10-star-fish-sea-beach-sand-wallpaper.jpg')";
        ...
        $('html').css('background', 'url(https://static.pexels.com/photos/96389/pexels-photo-96389.jpeg)');
    }
